...
const RecommendedForYou = () => {
    ...
    const fetchRecommendedProducts = async () => {
      try {
        ...
        const endpoints = [
          ...
          'http://localhost:8086/api/products/category/chains',
          'http://localhost:8086/api/products/category/menskada'
        ];
  ...
  return (
    <div className="recommended-for-you">
      <h2 className="recommended-for-you__heading">Recommended for You</h2>
